...
export function DoubleDownArrow() {
    return (
        <svg
...
export function RightArrowColor({ color }: Props) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
...
export function LockThreeLines() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
...
export function UnlockThreeLines() {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="1em"
