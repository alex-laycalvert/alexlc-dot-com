            ...
            <div className={styles.aboutMeDetails}>
                ...
                <div className={styles.aboutMeDetailsTextWrapper}>
                    <p className={styles.aboutMeDetailsText}>
                        ...
                        based out of Columbia, SC. I have been working in the IT industry for about
                        3 years now, a lot of that time being in System/Network administration.
                    </p>
                    <p className={styles.aboutMeDetailsText}>
                        My main passion is in technology and most of my time is spent working on
                        professional and personal programming projects. I pride myself in being able
                        to always accomplish my company&apos;s and clients&apos; missions,
